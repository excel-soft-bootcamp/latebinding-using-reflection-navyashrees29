    ...
    public class CheckSwitchCondition
    {
        public void SwitchCondition(Options _choice)
        {
                ...
                case Options.BASIC:
                    ...
                    string path = @"C: \Users\navyashrees\Documents\GitHub\latebinding -using-reflection - navyashrees29\GameApp\bin\Debug\LevelLibs\BasicLevelLib.dll";
                    string getType = "BasicLevelLib.BasicLevelType";
                    string getMethod = "Play";
                    CheckCondition condition = new CheckCondition(path, getType, getMethod);
